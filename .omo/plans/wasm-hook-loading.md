...
- Evidence: .omo/evidence/task-<N>-wasm-hook-loading.<ext>
...
- [ ] 1. <title>
  ...
  QA scenarios (name the exact tool + invocation): happy + failure, Evidence .omo/evidence/task-1-wasm-hook-loading.<ext>
