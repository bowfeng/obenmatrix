...
fn make_vision_analyze_tool() -> Tool {
    ...
    Tool {
        ...
        description: "Analyze images from URLs using vision AI. Downloads the image and performs analysis.".into(),
...
fn make_vision_analyze_handler() -> ToolHandler {
    Arc::new(|args: Value| {
        Box::pin(async move {
            ...
            let response = match client.get(image_url)
...
mod tests {
    ...
    async fn blocks_localhost() {
        ...
        let result = registry.execute("vision_analyze", &json!({
