...
| S.7 | Memory Provider abstraction (`MemoryProvider` trait + prefetch/recall + sync) | 🔴 | ✅ | [#31](https://github.com/bowfeng/obenagent/issues/31), [#43](https://github.com/bowfeng/obenagent/pull/43) | `MemoryProvider` trait (14 methods), `BuiltinProvider`, `MemoryManager` (tool routing, fan-out), `StreamingContextScrubber` |
